        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              +EV (positive expected value) bets have better odds than their true probability.
              Kelly Criterion suggests optimal bet sizing based on edge. We use quarter-Kelly 
              for more conservative bankroll management. Always bet responsibly.
            </p>
          </div>
        </div>
      </div>
